    ...
    <section class="section-padding">
        <div class="container" style="max-width: 800px; margin: 0 auto;">
            ...
            <p class="section-subtitle" style="text-align: left; margin-bottom: 40px;">
                We frequently conduct blood donation drives in collaboration with <strong>Sir Sunderlal Hospital, Institute of Medical Sciences, Banaras Hindu University</strong> to help people in need. We were also felicitated by the hospital on the occasion of World Blood Donor Day.
            </p>
            ...
            <div class="list-card border-orange" style="margin-bottom: 40px;">
                ...
                <ul class="custom-list mt-3">
                    ...
                    <li>Collected more than <strong>1000 units of blood</strong>, saving more than <strong>4000 lives</strong>.</li>
